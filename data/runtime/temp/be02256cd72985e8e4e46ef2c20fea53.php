<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:53:"/eddftp/card/app/admin/view/player/all_room_page.html";i:1504649246;s:47:"/eddftp/card/app/admin/view/public/content.html";i:1502609788;s:47:"/eddftp/card/app/admin/view/public/head_in.html";i:1502609788;s:45:"/eddftp/card/app/admin/view/public/alert.html";i:1502609788;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <!-- START CONTENT FRAME -->
            ...
            <!-- START CONTENT FRAME TOP -->
                <div class="page-title">
                    <h2><span class="fa fa-arrow-circle-o-left"></span>房间管理</h2>
                </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <ul class="panel-controls">
                <label class="label label-info"><?php echo $roomNums; ?></label>
            </ul>
        </div>
        <div class="panel-body">
            <table class="table table-hover">
                ...
                <tr class="del_tr" aa="<?php echo $v['room_code']; ?>">
                    <td width="10px">
                        <label class="check"><input type="checkbox" name="rooms[]" class="icheckbox" value="<?php echo $v['room_id']; ?>" /></label>
                    </td>
                    ...
                    <td><strong><?php echo !empty($v['showpoker']) && $v['showpoker']==1?'显示':'不显示'; ?></strong></td>
