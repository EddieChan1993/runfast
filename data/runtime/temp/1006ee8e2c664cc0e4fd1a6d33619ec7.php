                        ...
                        <form id="add_form2" action="<?php echo url('admin/Setting/edit_rank'); ?>" method="post" class="form-horizontal">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">自己充值折扣<?php echo $rank1['self_account']; ?>%</label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">下线充值折扣<?php echo $rank1['child_account']; ?>%</label>
                                        <div class="col-md-9">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">自己充值折扣<?php echo $rank2['self_account']; ?>%</label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">下线充值折扣<?php echo $rank2['child_account']; ?>%</label>
                                            <div class="col-md-9">
