<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:51:"/var/www/card/app/admin/view/admin/edit_agency.html";i:1502609781;s:48:"/var/www/card/app/admin/view/public/head_in.html";i:1502609787;s:46:"/var/www/card/app/admin/view/public/alert.html";i:1502609787;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-10">
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 control-label">绑定玩家ID</label>
                        <div class="col-xs-9">
                            <input name="player_id" value="<?php echo $player_id; ?>" type="text" class="form-control"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            ...
                            <span class="help-block">不修改密码可不填该选项</span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 control-label">代理等级</label>
                        <div class="col-xs-9">
                            <select name="user_rank" class="form-control select">
                                ...
                                <option <?php echo is_selected($user_rank,$v['rank_id']); ?> value="<?php echo $v['rank_id']; ?>"><?php echo $v['rank_name']; ?></option>
